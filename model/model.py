...
class Model:
    ...
    def getBFSNodes(self, source):  # Metodo per il bread first source
    ...
    def buildGraph(self):
        ...
        self.addEdgeMode3()  # scegliamo il modo per creare il grafo
    ...
    def addEdgePesati(self):
        ...
        for c in allConnessioni:
            ...
            # Se il peso è il numero di archi tra un nodo e l'altro:
    ...
    def getEdgeWeight(self, v1, v2):  # Metodo che ritorna il peso dell'arco
